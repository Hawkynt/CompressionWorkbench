...
| --- | --- | --- | :---: | :---: | :---: | --- | --- |
| [ASF / WMV / WMA](https://en.wikipedia.org/wiki/Advanced_Systems_Format) | `Asf` | `.asf` `.wma` `.wmv` | ✅ | — | — | Header Object children and Data Object walked; the writer serves the audio mux route only | [Microsoft Learn](https://learn.microsoft.com/en-us/windows/win32/wmformat/overview-of-the-asf-format) |
