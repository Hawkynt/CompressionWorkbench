...
| [LZFSE](https://en.wikipedia.org/wiki/LZFSE) | `Lzfse` | `.lzfse` | ✅ | ✅ | ✅ | Optimizer encodes at the deepest match search and keeps the smallest of the LZFSE, LZVN and stored forms of each block | [GitHub](https://github.com/lzfse/lzfse) |
...
Every public and protected member of all 1172 types, generated from the built assembly and its XML documentation, is in [REFERENCE.md](https://github.com/Hawkynt/CompressionWorkbench/blob/main/Hawkynt.FileFormats.Archives/REFERENCE.md).
