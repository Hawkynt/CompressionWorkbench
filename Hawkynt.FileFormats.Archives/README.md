...
| [VobSub](https://en.wikipedia.org/wiki/VobSub) | `VobSub` | `.idx` | ✅ | ✅ | ✅ | Single subtitle stream; raw `.spu` muxes to 2 KiB MPEG-PS sectors, extracted `.bin` chunks remux byte-exact | [sam.zoy.org](http://sam.zoy.org/writings/dvd/subtitles/) |
