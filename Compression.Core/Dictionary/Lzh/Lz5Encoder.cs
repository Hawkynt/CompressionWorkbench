...
/// <summary>
/// Encodes data using the -lz5- format (LArc variant).
/// Plain LZSS with a 4KB sliding window, no Huffman coding.
/// </summary>
public static class Lz5Encoder {
  ...
  /// <summary>
  /// Encodes data using the -lz5- format.
  /// </summary>
