...
public partial class AmrWb
{
    private unsafe short voice_factor(                       /* (o) Q15   : factor (-1=unvoiced to 1=voiced) */
         short* exc,                         /* (i) Q_exc : pitch excitation                 */
         short Q_exc,                         /* (i)       : exc format                       */
         short gain_pit,                      /* (i) Q14   : gain of pitch                    */
         short* code,                        /* (i) Q9    : Fixed codebook excitation        */
         short gain_code,                     /* (i) Q0    : gain of code                     */
         short L_subfr                        /* (i)       : subframe length                  */
    )
    {
        short i, tmp, exp, ener1, exp1, ener2, exp2;
        int L_tmp;

        exp1 = 0; exp2 = 0;
        ener1 = extract_h(Dot_product12(exc, exc, L_subfr, ref exp1));
        ...
        ener2 = extract_h(Dot_product12(code, code, L_subfr, ref exp2));
