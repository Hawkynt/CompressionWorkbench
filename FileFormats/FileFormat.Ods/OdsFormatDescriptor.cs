...
/// </list>
/// </summary>
public sealed class OdsFormatDescriptor : IFormatDescriptor, IArchiveFormatOperations, IArchiveCreatable, IArchiveModifiable, IArchiveDefragmentable, IArchiveLayoutMap {

  /// <inheritdoc />
  public IEnumerable<DefragBlockInfo> EnumerateLayout(Stream archive) => FileFormat.Zip.ZipLayoutMap.Enumerate(archive);

  /// <summary>Rebuild-based defrag delegating to ZIP (ODS is a ZIP variant).</summary>
  ...
  /// <summary>
  /// Adds (or replaces by name) files inside an existing ODS archive. Routes to
  ...
  /// </summary>
  public string DefaultExtension => ".ods";
  /// <summary>
  /// Gets the extensions.
  /// </summary>
  public IReadOnlyList<string> Extensions => [".ods"];
  /// <summary>
  ...
  /// </summary>
  public string Description => "OpenDocument spreadsheet (ZIP-based)";
