...
/// </list>
/// </summary>
public sealed class KmzFormatDescriptor : IFormatDescriptor, IArchiveFormatOperations, IArchiveCreatable, IArchiveModifiable, IArchiveDefragmentable, IArchiveLayoutMap {
...
public IEnumerable<DefragBlockInfo> EnumerateLayout(Stream archive) => FileFormat.Zip.ZipLayoutMap.Enumerate(archive);
  ...
  /// <summary>Rebuild-based defrag delegating to ZIP (KMZ is a ZIP variant).</summary>
...
public FormatCapabilities Capabilities =>
  ...
  /// <summary>
  /// Adds (or replaces by name) files inside an existing KMZ archive. Routes to
  ...
  /// </summary>
public string DefaultExtension => ".kmz";
  /// <summary>
  /// Gets the extensions.
  /// </summary>
public IReadOnlyList<string> Extensions => [".kmz"];
  /// <summary>
...
public AlgorithmFamily Family => AlgorithmFamily.Archive;
  ...
  /// </summary>
public string Description => "Google Earth KMZ (ZIP-based)";
