...
/// carries a 6510 program that drives the C64's MOS 6581/8580 SID chip; there is no audio to
/// decode, so the C64 program image is surfaced verbatim as a Kind <c>Stream</c> blob.
