...
public sealed class AomeiInfoRecord {
  ...
  public string TypeName => this.Header.Type switch {
    ...
    AomeiConstants.InfoTypeFlbSubEntryList     => "INFO_TYPE_FLB_SUB_ENTRY_LIST",
    AomeiConstants.InfoTypeFlbFileDataBlockList => "INFO_TYPE_FLB_FILE_DATA_BLOCK_LIST",
    AomeiConstants.InfoTypeVolumeDataRegion  => "INFO_TYPE_VOLUME_DATA_REGION",
