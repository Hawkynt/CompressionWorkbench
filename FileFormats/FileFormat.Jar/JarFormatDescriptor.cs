...
public FormatCapabilities Capabilities =>
  ...
  /// <summary>
  /// Adds (or replaces by name) files inside an existing JAR archive. Routes to
  ...
  /// </summary>
public string DefaultExtension => ".jar";
    /// <summary>
  /// Gets the extensions.
  /// </summary>
public IReadOnlyList<string> Extensions => [".jar"];
    /// <summary>
...
public AlgorithmFamily Family => AlgorithmFamily.Archive;
  ...
  /// </summary>
public string Description => "Java Archive (ZIP-based)";
