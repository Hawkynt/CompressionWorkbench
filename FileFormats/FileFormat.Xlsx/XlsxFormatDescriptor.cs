...
/// </list>
/// </summary>
public sealed class XlsxFormatDescriptor : IFormatDescriptor, IArchiveFormatOperations, IArchiveCreatable, IArchiveModifiable, IArchiveDefragmentable, IArchiveLayoutMap {
...
public IEnumerable<DefragBlockInfo> EnumerateLayout(Stream archive) => FileFormat.Zip.ZipLayoutMap.Enumerate(archive);
  ...
  /// <summary>Rebuild-based defrag delegating to ZIP (XLSX is a ZIP variant).</summary>
...
public string Id => "Xlsx";
  ...
  /// </summary>
public string DisplayName => "XLSX";
    /// <summary>
  /// Gets the category.
  /// </summary>
...
public FormatCapabilities Capabilities =>
  ...
  /// <summary>
  /// Adds (or replaces by name) files inside an existing XLSX archive. Routes to
...
public AlgorithmFamily Family => AlgorithmFamily.Archive;
  ...
  /// </summary>
public string Description => "Office Open XML spreadsheet (ZIP-based)";
