...
internal static partial class FormatDetector {
  ...
  internal static bool IsArchive(Format f) {
    if (f == Format.Sfx) 
      return true;
  ...
  internal static bool IsStreamFormat(Format f) {
    var desc = GetDesc(f);
    return desc?.Category is FormatCategory.Stream or FormatCategory.Wrapper;
  }

  internal static bool IsCompoundTar(Format f) {
    var desc = GetDesc(f);
  ...
  internal static Format? GetTarCompression(Format f) {
    EnsureRegistryMapped();
  ...
  internal static Format? GetCompoundTar(Format compression) {
    EnsureRegistryMapped();
  ...
  internal static string GetDefaultExtension(Format format) {
  ...
  internal static bool IsStreamExtension(string ext) {
    EnsureRegistryMapped();
