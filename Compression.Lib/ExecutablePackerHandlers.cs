...
public static class ExecutablePackerHandlers {
  private static readonly Lazy<IReadOnlyList<IExecutablePackerHandler>> RegisteredHandlers = new(() => [
    ...
    new DescriptorExecutablePackerHandler(new MewFormatDescriptor()),
    new DescriptorExecutablePackerHandler(new NsPackFormatDescriptor()),
    new DescriptorExecutablePackerHandler(new PetiteFormatDescriptor()),
    ...
    new DescriptorExecutablePackerHandler(new ThemidaFormatDescriptor()),
    new DescriptorExecutablePackerHandler(new VmProtectFormatDescriptor()),
    new DescriptorExecutablePackerHandler(new YodaCrypterFormatDescriptor()),
    ...
    new ThemidaFallbackExecutablePackerHandler(),
