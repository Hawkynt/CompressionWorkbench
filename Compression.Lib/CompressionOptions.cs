...
public sealed class CompressionOptions {
  ...
  public MethodSpec Method { get; init; } = MethodSpec.Default;
  ...
  /// </summary>
  public int ResolveLzmaDictSize() {
  ...
  /// </summary>
  public Compression.Core.Dictionary.Lzma.LzmaCompressionLevel ResolveLzmaLevel() {
  ...
  /// </summary>
  public int ResolveBzip2BlockSize() {
  ...
  /// </summary>
  public int ResolvePpmdOrder(int defaultOrder = 6) {
  ...
  /// </summary>
  public int ResolvePpmdMemorySize() {
