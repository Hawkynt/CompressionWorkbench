...
| [Acorn ADFS](Adfs.md) | moving (`AdfsBlockMover`) | yes | yes |
...
| [BeeGFS](BeeGfs.md) | — | no | no |
| [BFS](Bfs.md) | moving (`BfsBlockMover`) | yes | yes |
| [Btrfs Filesystem Image](Btrfs.md) | moving (`BtrfsBlockMover`) | yes | yes |
| [CephFS / RADOS](CephFs.md) | — | no | no |
| [Coherent FS](Coherent.md) | moving (`CoherentBlockMover`) | yes | yes |
...
| [SGI CXFS (Cluster XFS)](Cxfs.md) | — | no | no |
...
| [eCryptfs](Ecryptfs.md) | rebuilding | no | no |
...
| [G64 (Commodore GCR)](G64.md) | rebuilding | yes | yes |
...
| [GlusterFS](GlusterFs.md) | — | no | no |
| [IBM Spectrum Scale / GPFS](Gpfs.md) | — | no | no |
| [Apple IIgs GS/OS (2IMG)](GsOs.md) | rebuilding | no | yes |
| [HAMMER (DragonFly BSD)](Hammer.md) | moving (`HammerBlockMover`) | yes | yes |
| [HAMMER2 (DragonFly BSD)](Hammer2.md) | moving (`Hammer2BlockMover`) | yes | yes |
...
| [Dell EMC Isilon OneFS](OneFs.md) | — | no | no |
| [OpenVMS Files-11](OpenVms.md) | moving (`OpenVmsBlockMover`) | yes | yes |
| [OrangeFS / PVFS2 DBPF](OrangeFs.md) | rebuilding | no | yes |
...
| [PlayStation Memory Card](Ps1MemoryCard.md) | rebuilding | yes | yes |
| [QNX4 FS](Qnx4.md) | moving (`Qnx4BlockMover`) | yes | yes |
| [QNX6 Neutrino FS](Qnx6.md) | moving (`Qnx6BlockMover`) | yes | yes |
| [ReFS](Refs.md) | moving (`RefsBlockMover`) | yes | yes |
...
| [Amiga SFS](Sfs.md) | moving (`SfsBlockMover`) | yes | no |
| [SmartFS](SmartFs.md) | moving (`SmartFsBlockMover`) | yes | no |
| [SquashFS](SquashFs.md) | moving (`SquashFsBlockMover`) | yes | yes |
| [Stacker CVF](Stacker.md) | rebuilding | yes | yes |
| [UNIX System V FS](SysV.md) | moving (`SysVBlockMover`) | yes | yes |
| [Transactional FAT (TFAT)](TFat.md) | rebuilding | yes | yes |
| [Tahoe-LAFS share](TahoeLafs.md) | rebuilding | no | no |
