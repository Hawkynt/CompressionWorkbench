...
public sealed class DriveSpaceFormatDescriptor : IFormatDescriptor, IArchiveFormatOperations {
  ...
  public string Description => "Microsoft DriveSpace compressed volume file (MS-DOS 6.22+/Windows 95)";
  ...
  public void Create(Stream output, IReadOnlyList<ArchiveInputInfo> inputs, FormatCreateOptions options) {
    var w = new DoubleSpaceWriter { DriveSpace = true };
