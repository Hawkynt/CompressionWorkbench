...
| `RealMedia` | RealMedia / RealAudio | R | — | — | — | — | [ffmpeg][ffmpeg] RealAudio 14.4 stream, byte-exact | RealMedia, codec-routed audio channels |
...
Every public and protected member of all 1272 types, generated from the built assembly and its XML documentation, is in [REFERENCE.md](https://github.com/Hawkynt/CompressionWorkbench/blob/main/Hawkynt.FileFormats.Audio/REFERENCE.md).
