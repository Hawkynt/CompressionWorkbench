...
| `Ac3` | AC-3 / E-AC-3 | R | ✅ | ✅ | — | — | [ffmpeg][ffmpeg] stream converts to its declared length | Raw AC-3/E-AC-3 independent substreams |
...
Every public and protected member of all 1269 types, generated from the built assembly and its XML documentation, is in [REFERENCE.md](https://github.com/Hawkynt/CompressionWorkbench/blob/main/Hawkynt.FileFormats.Audio/REFERENCE.md).
