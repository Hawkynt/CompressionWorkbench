...
| `Asf` | ASF (Advanced Systems Format) | R/W | — | — | ✅ | ✅ | Microsoft ASF, WMA-family audio depayload/decode routes + tags; packet-preserving demux/mux, now multi-track and codec-preserving from canonical per-stream artifacts |
...
Every public and protected member of all 1267 types, generated from the built assembly and its XML documentation, is in [REFERENCE.md](https://github.com/Hawkynt/CompressionWorkbench/blob/main/Hawkynt.FileFormats.Audio/REFERENCE.md).
