/*___________________________________________________________________________
 ...
 |                                                                           |
 |  int L_32     : standard signed 32 bits format                         |
 |  short hi, lo   : L_32 = hi<<16 + lo<<1  (DPF - Double Precision Format) |
 |  int frac, short exp : L_32 = frac << exp-31  (normalised format)     |
 |  short int, frac        : L_32 = int.frac        (fractional format)     |
 |___________________________________________________________________________|
*/
...
public partial class AmrWb
{
    /*___________________________________________________________________________
     ...
     |___________________________________________________________________________|
    */
    private int Isqrt(                              /* (o) Q31 : output value (range: 0<=val<1)         */
    ...
    /*___________________________________________________________________________
     ...
     |___________________________________________________________________________|
    */
    private static  short[] table_isqrt = new short[]
    {
    ...
    private void Isqrt_n(
         ref int frac,                        /* (i/o) Q31: normalized value (1.0 < frac <= 0.5) */
         ref short exp                          /* (i/o)    : exponent (value = frac x 2^exponent) */
    )
    {
        short i, a, tmp;
        ...
        {
            exp = 0;    //move16();
            frac = (int) 0x7fffffffL; //move32();
            return;
        }
        //test(); 
        //logic16();
        if (sub((short)(exp & 1), 1) == 0)  /* If exponant odd -> shift right */
            frac = L_shr(frac, 1);
        ...
        a = (short)(a & (short)0x7fff); //logic16();
    ...
    /*___________________________________________________________________________
     ...
     |___________________________________________________________________________|
    */
    private static short[] table_pow2 = new short[]
    {
    ...
    private int Pow2(                               /* (o) Q0  : result       (range: 0<=val<=0x7fffffff) */
    ...
    */
    ...
    private int Dot_product12(                /* (o) Q31: normalized result (1 < val <= -1) */
         short[] x,                           /* (i) 12bits: x vector                       */
         short[] y,                           /* (i) 12bits: y vector                       */
         short lg,                            /* (i)    : vector length                     */
         ref short exp)                        /* (o)    : exponent of result (0..+30)       */
    {
        short i, sft;
        int L_sum;
    ...
    // 30 Apr 25 PHE
    private unsafe int Dot_product12(                /* (o) Q31: normalized result (1 < val <= -1) */
         short* x,                           /* (i) 12bits: x vector                       */
         short* y,                           /* (i) 12bits: y vector                       */
         short lg,                            /* (i)    : vector length                     */
         ref short exp)                        /* (o)    : exponent of result (0..+30)       */
