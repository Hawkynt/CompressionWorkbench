...
public class IsoTests {
  ...
  public void RoundTrip_SingleFile() {
    ...
    var w = new FileFormat.Iso.IsoWriter();
    w.AddFile("TEST.TXT", data);
    var image = w.Build();

    using var ms = new MemoryStream(image);
    var r = new FileFormat.Iso.IsoReader(ms);
  ...
  public void Descriptor_Properties() {
    var desc = new FileFormat.Iso.IsoFormatDescriptor();
  ...
  public void Reader_TooSmall_Throws() {
    ...
    Assert.Throws<InvalidDataException>(() => _ = new FileFormat.Iso.IsoReader(ms));
  }
