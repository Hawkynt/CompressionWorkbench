...
public class TrDosTests {
  ...
  public void RoundTrip_SingleFile() {
    ...
    var r = new FileSystem.TrDos.TrDosReader(ms);
  ...
  public void Descriptor_Properties() {
    var desc = new FileSystem.TrDos.TrDosFormatDescriptor();
  ...
  public void Reader_TooSmall_Throws() {
    ...
    Assert.Throws<InvalidDataException>(() => _ = new FileSystem.TrDos.TrDosReader(ms));
  }
