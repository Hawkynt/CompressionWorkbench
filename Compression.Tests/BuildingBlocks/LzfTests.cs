using System.Text;
using Compression.Core.Dictionary.Lzf;
...
public class LzfTests {
  ...
  private static readonly LzfBuildingBlock Bb = new();
  ...
  public void BbRegistry_ExposesMetadata() {
    Assert.That(Bb.Id, Is.EqualTo("BB_Lzf"));
    Assert.That(Bb.DisplayName, Is.EqualTo("LZF"));
