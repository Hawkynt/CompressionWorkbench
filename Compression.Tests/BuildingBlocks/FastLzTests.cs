using System.Text;
using Compression.Core.Dictionary.FastLz;
...
public class FastLzTests {
  ...
  private static readonly FastLzBuildingBlock Bb = new();
  ...
  public void BbRegistry_ExposesMetadata() {
    Assert.That(Bb.Id, Is.EqualTo("BB_FastLz"));
    Assert.That(Bb.DisplayName, Is.EqualTo("FastLZ"));
