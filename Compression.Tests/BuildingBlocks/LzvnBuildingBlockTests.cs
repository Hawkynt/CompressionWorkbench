using System.Text;
using Compression.Core.Dictionary.Lzvn;
using Compression.Registry;

namespace Compression.Tests.BuildingBlocks;

[TestFixture]
public class LzvnBuildingBlockTests {

  private static readonly LzvnBuildingBlock Bb = new();
  ...
  public void LongDistanceMatch_RoundTrips() {
    // Force a match distance far beyond the 2-byte tier to exercise the 5-byte form.
  ...
  public void BbRegistry_ExposesMetadata() {
    Assert.That(Bb.Id, Is.EqualTo("BB_Lzvn"));
    Assert.That(Bb.DisplayName, Is.EqualTo("LZVN"));
