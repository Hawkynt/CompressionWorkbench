using System.Text;
using Compression.Core.Dictionary.Lzfx;
using Compression.Registry;

namespace Compression.Tests.BuildingBlocks;

[TestFixture]
public class LzfxTests {

  private static readonly LzfxBuildingBlock Bb = new();
  ...
  public void BbRegistry_ExposesMetadata() {
    Assert.That(Bb.Id, Is.EqualTo("BB_Lzfx"));
    Assert.That(Bb.DisplayName, Is.EqualTo("LZFX"));
