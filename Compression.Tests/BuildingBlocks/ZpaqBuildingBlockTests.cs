...
[TestFixture]
public class ZpaqBuildingBlockTests {

  private static readonly ZpaqBuildingBlock Bb = new();
  ...
  public void Registry_Metadata_IsStable() {
    Assert.Multiple(() => {
      Assert.That(Bb.Id, Is.EqualTo("BB_Zpaq"));
      Assert.That(Bb.DisplayName, Is.EqualTo("ZPAQ"));
