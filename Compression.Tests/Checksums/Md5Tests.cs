...
public class Md5Tests {
  ...
  public void MessageDigest() {
    byte[] hash = Md5.Compute("message digest"u8);
  ...
  public void Alphabet() {
    byte[] hash = Md5.Compute("abcdefghijklmnopqrstuvwxyz"u8);
