...
[TestFixture]
public class ApplePascalGeometrySelectorTests {

  [Test]
  public void Find_BlockSizeAlways512() {
    var g = ApplePascalGeometrySelector.Find([1000, 2000]);
  ...
  public void Find_VolumeBlocksAreMultipleOf8() {
    var g = ApplePascalGeometrySelector.Find([1000, 2000, 3000]);
  ...
  public void Find_MinimumIs280Blocks() {
    var g = ApplePascalGeometrySelector.Find([10]);
  ...
  public void Find_ResultIsValidWriterInput() {
    var g = ApplePascalGeometrySelector.Find([3000, 5000]);
