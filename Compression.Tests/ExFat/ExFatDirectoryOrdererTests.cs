...
public sealed class ExFatDirectoryOrdererTests {
  ...
  [Category("Regression")]
  public void SortDirectoryEntries_RecursesAndPreservesEntrySetsPayloadAndAllocation() {
    ...
    using var image = new MemoryStream(writer.BuildAutoSized(volumeLabel: "ORDERTEST"));
  ...
  public void Descriptor_AdvertisesDirectoryOrderingSeparatelyFromDefragmentation() {
    IFormatDescriptor descriptor = new ExFatFormatDescriptor();
  ...
  private static SnapshotResult Snapshot(MemoryStream image, ExFatFormatDescriptor descriptor) {
    image.Position = 0;
