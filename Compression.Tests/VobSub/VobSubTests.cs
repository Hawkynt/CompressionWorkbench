...
public class VobSubTests {
  ...
  public void Writer_RawSpuMux_ProducesDvdSizedMpegProgramStreamSectors() {
    ...
    Assert.Multiple(() => {
      ...
      Assert.That(pair.SubBytes.AsSpan(0, 4).SequenceEqual([0x00, 0x00, 0x01, 0xBA]), Is.True);
      Assert.That(pair.SubBytes.AsSpan(14, 4).SequenceEqual([0x00, 0x00, 0x01, 0xBD]), Is.True);
