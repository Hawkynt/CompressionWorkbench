...
/// <summary>
/// Finds the payloads the base segment holds and the eight bytes that say where
/// each one starts.
/// </summary>
/// <remarks>
...
/// </remarks>
internal static class Nilfs1Layout {
  ...
  public static Layout? Read(Stream image) {
    ...
    var segmentStart = (long)Nilfs1Writer.SegmentStart;
    var head = ReadBytes(image, segmentStart, Nilfs1Writer.WriterMagic.Length + 8);
    ...
    var directoryStart = segmentStart + Nilfs1Writer.WriterMagic.Length + 8;
    var payloadStart = directoryStart + directorySize;
    ...
    layout.PayloadEnd = FindFirstAppendedSegment(image, scanFrom) ?? image.Length;
    return layout;
  }
