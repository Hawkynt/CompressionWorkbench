...
| [eCryptfs](https://en.wikipedia.org/wiki/ECryptfs) | `Ecryptfs` | R | ✅ rebuild | — | — | — | detection of the on-disk signature | Payload is encrypted; plaintext needs the FEK | [eCryptfs](https://www.kernel.org/doc/html/latest/filesystems/ecryptfs.html) |
...
| [Tahoe-LAFS share](https://en.wikipedia.org/wiki/Tahoe-LAFS) | `TahoeLafs` | R | ✅ rebuild | — | — | — | detection of the on-disk signature | Shares are capability-encrypted; no read-cap, no plaintext | [Tahoe-LAFS](https://tahoe-lafs.org/) |
