...
| [VDI](https://en.wikipedia.org/wiki/VirtualBox#Virtual_disk_image) | `Vdi` | R/W | ✅ | ✅ rebuild | ✅ | — | — | ✅ | [`qemu-img check`](https://www.qemu.org/docs/master/tools/qemu-img.html) / `convert -O raw` / reverse `qemu-img create` | Edits go to the inner filesystem | [VirtualBox storage](https://www.virtualbox.org/manual/ch05.html) |
| [VHD](https://en.wikipedia.org/wiki/VHD_(file_format)) | `Vhd` | R/W | ✅ | ✅ rebuild | ✅ | — | — | ✅ | [`qemu-img check`](https://www.qemu.org/docs/master/tools/qemu-img.html) / `convert -O raw` / reverse `qemu-img create` | Fixed, dynamic and differencing; edits go to the inner filesystem | [Microsoft VHD](https://learn.microsoft.com/windows-server/virtualization/hyper-v/manage/manage-hyper-v-virtual-hard-disks) |
| [VHDX](https://en.wikipedia.org/wiki/VHD_(file_format)#VHDX) | `Vhdx` | R/W | ✅ | ✅ rebuild | ✅ | — | — | ✅ | [`qemu-img`](https://www.qemu.org/docs/master/tools/qemu-img.html) reader interoperability + reverse `qemu-img create` | Edits go to the inner filesystem | [MS-VHDX](https://learn.microsoft.com/en-us/openspecs/windows_protocols/ms-vhdx/) |
| [VMDK](https://en.wikipedia.org/wiki/VMDK) | `Vmdk` | R/W | ✅ | ✅ rebuild | ✅ | — | — | ✅ | [`qemu-img check`](https://www.qemu.org/docs/master/tools/qemu-img.html) / `convert -O raw` / reverse `qemu-img create` | Edits go to the inner filesystem | [VMware Virtual Disk API](https://developer.broadcom.com/xapis/virtual-disk-api/latest/) |
...
| [FAT+ Filesystem Image (large-file extension)](https://en.wikipedia.org/wiki/File_Allocation_Table#FAT+) | `FatPlus` | R/W | ✅ | ✅ rebuild | ✅ | ✅ | ✅ | ✅ | host-kernel `vfat` mount + [`fsck.fat`](https://github.com/dosfstools/dosfstools) read the written volume | FAT+ large-file extension | [FAT+ draft](https://www.fdos.org/kernel/fatplus.txt) |
...
| [NTFS](https://en.wikipedia.org/wiki/NTFS) | `Ntfs` | R/W | ✅ | ✅ moving | ✅ | ✅ | ✅ | ✅ | [`ntfsls` / `ntfsinfo` / `ntfsfix`](https://github.com/tuxera/ntfs-3g) (ntfs-3g) + reverse `mkfs.ntfs` | Edits relayout the volume; `ntfs3` mounts it but lists an empty root (root `$I30` index pending) | [MS-FSCC](https://learn.microsoft.com/en-us/openspecs/windows_protocols/ms-fscc/) |
...
| [Btrfs Filesystem Image](https://en.wikipedia.org/wiki/Btrfs) | `Btrfs` | R/W | ✅ | ✅ moving | ✅ | ✅ | ✅ | ✅ | [`btrfs check --readonly`](https://github.com/kdave/btrfs-progs), also after mutation | Edits relayout the volume | [Btrfs on-disk format](https://btrfs.readthedocs.io/en/latest/dev/On-disk-format.html) |
...
| [GFS2 (Global File System 2)](https://en.wikipedia.org/wiki/GFS2) | `Gfs2` | R/W | ✅ | ✅ moving | ✅ | ✅ | ✅ | ✅ | [`fsck.gfs2 -n`](https://pagure.io/gfs2-utils) clean on populated create and after add/replace/remove; reverse `mkfs.gfs2` reader coverage | Standalone `lock_nolock`; stuffed + indirect-tree files; edits rebuild while preserving image-size floor and lock table | [GFS2](https://www.kernel.org/doc/html/latest/filesystems/gfs2.html) |
...
| [NILFS2](https://en.wikipedia.org/wiki/NILFS) | `Nilfs2` | R/W | ✅ | ✅ moving | ✅ | ✅ | ✅ | ✅ | host-kernel loop-mount reads the in-place-added file byte-exact; [`mkfs.nilfs2`](https://nilfs.sourceforge.io/) superblock re-validated | — | [NILFS](https://nilfs.sourceforge.io/) |
| [OCFS2 (Oracle Cluster Filesystem 2)](https://en.wikipedia.org/wiki/OCFS2) | `Ocfs2` | R/W | ✅ | ✅ moving | ✅ | ✅ | ✅ | ✅ | [`fsck.ocfs2 -fn`](https://github.com/markfasheh/ocfs2-tools) + `debugfs.ocfs2`; `mkfs.ocfs2` image read by the package | Edits rebuild the volume | [OCFS2](https://www.kernel.org/doc/html/latest/filesystems/ocfs2.html) |
