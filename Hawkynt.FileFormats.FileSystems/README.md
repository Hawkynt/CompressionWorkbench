...
| [XFS](https://en.wikipedia.org/wiki/XFS) | `Xfs` | R/W | ✅ | ✅ moving | ✅ | ✅ | ✅ | ✅ | host-kernel `xfs` mount r/w + [`xfs_repair -n`](https://git.kernel.org/pub/scm/fs/xfsprogs-dev.git) | XFS v5 | [XFS documentation](https://kernel.org/doc/html/latest/filesystems/xfs/index.html) |
