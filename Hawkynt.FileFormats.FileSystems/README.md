...
| [T64](https://en.wikipedia.org/wiki/Commodore_64) | `T64` | R/W | ✅ | ✅ moving | ✅ | — | — | ✅ | own reader + struct-parity tests | C64 Lynx archive | [T64 (VICE)](https://vice-emu.sourceforge.io/vice_17.html) |
...
| [F2FS](https://en.wikipedia.org/wiki/F2FS) | `F2fs` | R/W | ✅ | ✅ moving | ✅ | ✅ | ✅ | ✅ | host-kernel `f2fs` mount r/w + [`fsck.f2fs`](https://git.kernel.org/pub/scm/linux/kernel/git/jaegeuk/f2fs-tools.git) | — | [F2FS documentation](https://www.kernel.org/doc/html/latest/filesystems/f2fs/) |
...
| [TFS (unverified historical BBN Trans-FS label)](https://github.com/Hawkynt/CompressionWorkbench/blob/main/Hawkynt.FileFormats.FileSystems/FileSystems/FileSystem.Tfs/FORMAT-NOTES.md) | `Tfs` | R | — | — | — | — | — | — | no external oracle; automatic detection deliberately disabled | Historical BBN Trans-FS identity, magic and extension remain unverified; explicit format selection only | [TFS provenance notes](https://github.com/Hawkynt/CompressionWorkbench/blob/main/Hawkynt.FileFormats.FileSystems/FileSystems/FileSystem.Tfs/FORMAT-NOTES.md) |
...
Every public and protected member of all 850 types, generated from the built assembly and its XML documentation, is in [REFERENCE.md](https://github.com/Hawkynt/CompressionWorkbench/blob/main/Hawkynt.FileFormats.FileSystems/REFERENCE.md).
