...
| [ReiserFS](https://en.wikipedia.org/wiki/ReiserFS) | `ReiserFs` | R/W | ✅ | ✅ moving | ✅ | ✅ | ✅ | ✅ | [`reiserfsck`](https://git.kernel.org/pub/scm/linux/kernel/git/jeffm/reiserfsprogs-dev.git), also after mutation | ReiserFS 3.6; edits rebuild the tree | [ReiserFS documentation](https://www.kernel.org/doc/html/latest/filesystems/reiserfs.html) |
...
| [EROFS](https://en.wikipedia.org/wiki/EROFS) | `Erofs` | R/W | ✅ | ✅ moving | ✅ | ✅ | ✅ | ✅ | [`mkfs.erofs`](https://git.kernel.org/pub/scm/linux/kernel/git/xiang/erofs-utils.git) image read byte-exact | Edits rebuild the image | [EROFS](https://erofs.docs.kernel.org/) |
...
| [UBIFS](https://en.wikipedia.org/wiki/UBIFS) | `Ubifs` | R/W | ✅ | ✅ moving | ✅ | ✅ | ✅ | ✅ | own reader + struct-parity tests | Log-structured; edits rebuild the volume | [UBIFS](https://www.kernel.org/doc/html/latest/filesystems/ubifs.html) |
